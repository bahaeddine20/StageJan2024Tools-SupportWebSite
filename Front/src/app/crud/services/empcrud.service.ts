...
export class EmpcrudService {
  ...
  getEmployeeById(id: number): Observable<any> {
    return this.http.get(`http://10.0.2.15:9091/emp/getEmployeeByID/${id}`);
  }

  getAllEmployees(): Observable<any> {
    return this.http.get(`http://10.0.2.15:9091/emp/getAllEmployees`);
  }
  ...
  addEmployee(employeeData: any, imageFiles: File[]): Observable<any> {
    ...
    return this.http.post<Employee>('http://10.0.2.15:9091/emp/addEmployee', formData);
  }
  ...
  updateEmployee(id: number, employeeData: Employee, imageFiles: File[]): Observable<any> {
    ...
    // Make the HTTP request
    return this.http.put<Employee>(`http://10.0.2.15:9091/emp/updateEmployee/${id}`, formData);
  }



  deleteEmployee(id: number): Observable<any> {
    return this.http.delete(`http://10.0.2.15:9091/emp/deleteEmployeeById/${id}`);
  }

  searchByGender(gender: string): Observable<any> {
    return this.http.get(`http://10.0.2.15:9091/emp/searchByGender/${gender}`);
  }

  getByTeam(idteam: string): Observable<any> {
    return this.http.get(`http://10.0.2.15:9091/emp/EmployeeByIdTeam/${idteam}`);
  }

  searchByBirthDateRange(startDate: string, endDate: string): Observable<any> {
    return this.http.get(`http://10.0.2.15:9091/emp/searchByBirthDateRange/${startDate}/${endDate}`);
  }
  ...
  searchByBirthYear(year: number): Observable<any> {
    return this.http.get(`http://10.0.2.15:9091/emp/searchByBirthYear/${year}`);
  }
}
